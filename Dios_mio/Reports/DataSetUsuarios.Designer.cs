...
namespace Dios_mio.Reports {
    ...
    public partial class DataSetUsuarios : global::System.Data.DataSet {
        ...
        public partial class UsuarioDataTable : global::System.Data.TypedTableBase<UsuarioRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public UsuarioRow AddUsuarioRow(string Nombre, string Apellido, string Username, string Password) {
...
namespace Dios_mio.Reports.DataSetUsuariosTableAdapters {
    ...
    public partial class UsuarioTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Usuario] ([Nombre], [Apellido], [Username], [Password]) VALUES" +
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Usuario] SET [Nombre] = @Nombre, [Apellido] = @Apellido, [Username]" +
                " = @Username, [Password] = @Password WHERE (([idUsuario] = @Original_idUsuario))" +
                "";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["PlanillaDBConnectionString"].ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT idUsuario, Nombre, Apellido, Username, Password FROM dbo.Usuario";
        ...
        public virtual int Insert(string Nombre, string Apellido, string Username, string Password) {
            if ((Nombre == null)) {
        ...
        public virtual int Update(string Nombre, string Apellido, string Username, string Password, int Original_idUsuario) {
            if ((Nombre == null)) {
                throw new global::System.ArgumentNullException("Nombre");
            }
            else {
